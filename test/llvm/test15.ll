...
; <label>:5                                       ; preds = %2
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [2 x %struct.simple], [2 x %struct.simple]* @fred, i64 0, i64 %7
  %9 = getelementptr inbounds %struct.simple, %struct.simple* %8, i32 0, i32 0
  %10 = load i32, i32* %9, align 8
  store i32 %10, i32* %local, align 4
  %11 = load i32, i32* %n, align 4
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [2 x %struct.simple], [2 x %struct.simple]* @fred, i64 0, i64 %12
  %14 = getelementptr inbounds %struct.simple, %struct.simple* %13, i32 0, i32 1
